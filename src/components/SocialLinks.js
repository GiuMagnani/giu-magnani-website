...
const SocialLinks = ({isBlue, className}) => {
  return (
    <SocialLinksWrapper is-blue={isBlue} className={className}>
      <ul>
        <li>
          <a href="https://www.behance.net/giumagnani" rel="noopener" target="_blank">
            <svg
        ...
        <li>
          <a href="https://github.com/giumagnani" rel="noopener" target="_blank">
        ...
        <li>
          <a href="https://dribbble.com/GiuMagnani" rel="noopener" target="_blank">
            <svg
              xmlns="http://www.w3.org/2000/svg"
        ...
        <li>
          <a href="https://www.pinterest.com/giumagnani/" rel="noopener" target="_blank">
            <svg
              xmlns="http://www.w3.org/2000/svg"
        ...
        <li>
          <a href="https://www.linkedin.com/in/giumagnani" rel="noopener" target="_blank">
            <svg
              xmlns="http://www.w3.org/2000/svg"
        ...
        <li>
          <a href="https://twitter.com/_GiuMagnani" rel="noopener" target="_blank">
            <svg
              xmlns="http://www.w3.org/2000/svg"
...
const SocialLinksWrapper = styled.div`
  ...
  li {
    ...
    &:hover a {
      background-color: ${props => (props["is-blue"] ? props.theme.main : "white")};
