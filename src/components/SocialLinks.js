...
const SocialLinks = ({isBlue, className}) => {
  return (
    <SocialLinksWrapper is-blue={isBlue} className={className}>
      <ul>
        <li>
          <a href="https://www.behance.net/giumagnani">
            <svg
        ...
        <li>
          <a href="https://github.com/giumagnani">
        ...
        <li>
          <a href="https://dribbble.com/GiuMagnani">
            <svg
              xmlns="http://www.w3.org/2000/svg"
        ...
        <li>
          <a href="https://www.pinterest.com/giumagnani/">
            <svg
              xmlns="http://www.w3.org/2000/svg"
        ...
        <li>
          <a href="https://www.linkedin.com/in/giumagnani">
            <svg
              xmlns="http://www.w3.org/2000/svg"
        ...
        <li>
          <a href="https://twitter.com/_GiuMagnani">
            <svg
              xmlns="http://www.w3.org/2000/svg"
