...
const SocialLinks = ({isBlue, className}) => {
  return (
    <SocialLinksWrapper is-blue={isBlue} className={className}>
      <ul>
        <li>
          <a href="https://www.behance.net/giumagnani" target="_blank">
            <svg
        ...
        <li>
          <a href="https://github.com/giumagnani" target="_blank">
        ...
        <li>
          <a href="https://dribbble.com/GiuMagnani" target="_blank">
            <svg
              xmlns="http://www.w3.org/2000/svg"
        ...
        <li>
          <a href="https://www.pinterest.com/giumagnani/" target="_blank">
            <svg
              xmlns="http://www.w3.org/2000/svg"
        ...
        <li>
          <a href="https://www.linkedin.com/in/giumagnani" target="_blank">
            <svg
              xmlns="http://www.w3.org/2000/svg"
        ...
        <li>
          <a href="https://twitter.com/_GiuMagnani" target="_blank">
            <svg
              xmlns="http://www.w3.org/2000/svg"
