      ...
      <Layout location={ this.props.location }>
        ...
        <AboutSection>
          <div className="container">
            <AboutSectionBody>
              <h2>
                Front-End Developer and UI/UX Designer based in Milan, Italy. </h2>
              <p>
              ...
              <AboutSectionSocialLinks>
                <ul>
                  ...
                  <li>
                    <a href="">
                      <svg xmlns="http://www.w3.org/2000/svg" aria-labelledby="behance-icon" viewBox="0 0 24 24">
                        <path
                  ...
                  <li>
                    <a href="">
                      <svg xmlns="http://www.w3.org/2000/svg" aria-labelledby="dribbble-icon" viewBox="0 0 24 24">
                        <path
                  ...
                  <li>
                    <a href="">
                      <svg xmlns="http://www.w3.org/2000/svg" aria-labelledby="pinterest-icon" viewBox="0 0 24 24">
                        <path
                  ...
                  <li>
                    <a href="">
                      <svg xmlns="http://www.w3.org/2000/svg" aria-labelledby="linkedin-icon" viewBox="0 0 24 24">
                        <path
                  ...
                  <li>
                    <a href="">
                      <svg xmlns="http://www.w3.org/2000/svg" aria-labelledby="twitter-icon" viewBox="0 0 24 24">
                        <path
        ...
        <LatestPostsContainer className="container">
