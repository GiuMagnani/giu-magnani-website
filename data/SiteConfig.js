module.exports = {
  ...
  googleAnalyticsID: "UA-47304762-1", // GA tracking ID.
  siteLogo: "/logos/giu-magnani-logo-1024.png", // Logo used for SEO and manifest.
  pathPrefix: "/", // Prefixes all links. For cases when deployed to example.github.io/gatsby-advanced-starter/.
  postDefaultCategoryID: "", // Default category for posts.
  copyright: "© 2019 Designed & Developed by Giu Magnani", // Copyright string for the footer of the website and RSS feed.
  themeColor: "#2222ff", // Used for setting manifest and progress theme colors.
